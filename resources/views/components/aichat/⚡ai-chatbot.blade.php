    ...
    <div class="bg-zinc-900 border-b border-zinc-800 px-6 py-6 shrink-0">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                {{-- AI Avatar --}}
                <div
                        class="w-9 h-9 rounded-full bg-zinc-700 border border-zinc-600 flex items-center justify-center shrink-0">
                ...
                <div>
                    <h1 class="text-zinc-100 font-semibold text-base leading-tight">AI Assistant</h1>
    ...
    <div x-ref="messages" x-on:scroll="autoScroll = ($el.scrollTop + $el.clientHeight >= $el.scrollHeight - 50)"
        ...
        @if(empty($messages))
            ...
            <div class="flex flex-col items-center justify-center h-full gap-4 text-center px-4">
                ...
                <div>
                    <h2 class="text-zinc-200 font-medium text-lg">AI Assistant</h2>
                    <p class="text-zinc-500 text-sm mt-1 max-w-xs">
                        Ask me anything about AI, LLM models, MCP, or any part of the AI and related knowledge ecosystem.
                    </p>
                </div>
                {{-- Suggestion chips --}}
    ...
    <div class="bg-zinc-900 border-t border-zinc-800 px-4 py-6 shrink-0">
        <div class="max-w-3xl mx-auto">
            ...
            >
                <div class="flex-1">
                    <textarea
                            ...
                            placeholder="Ask about AI, LLM, MCP, or any of related ..."
                            rows="1"
            ...
            <p class="text-zinc-600 text-xs text-center mt-3">
                AI Assistant can make mistakes. Always verify critical code and data.
            </p>
        </div>
    </div>
...
{{-- here not need. this connect in resources/views/partials/head.blade.php
