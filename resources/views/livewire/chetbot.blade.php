    ...
    <div class="bg-zinc-900 border-b border-zinc-800 px-6 py-6 shrink-0">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-zinc-100 font-semibold text-base leading-tight">VueJs Assistant</h1>
    ...
    <div x-ref="messages" x-on:scroll="autoScroll = ($el.scrollTop + $el.clientHeight >= $el.scrollHeight - 50)"
        ...
        @if(empty($messages))
            ...
            <div class="flex flex-col items-center justify-center h-full gap-4 text-center px-4">
                ...
                <div>
                    <h2 class="text-zinc-200 font-medium text-lg">VueJs Assistant</h2>
                    <p class="text-zinc-500 text-sm mt-1 max-w-xs">
                        Ask me anything about VueJs, Java Script, Inertia, Vue-Router, Pinia, or any part of the Vue ecosystem.
                    </p>
                </div>
                {{-- Suggestion chips --}}
